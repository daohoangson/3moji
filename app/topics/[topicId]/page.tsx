    ...
    <main className="min-h-screen overflow-x-hidden bg-gradient-to-br from-sky-100 via-blue-50 to-emerald-50 pb-12">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-4 sm:px-6 sm:py-8">
        ...
        <div className="mb-8 text-center sm:mb-12">
          <div className="mb-6 inline-block rounded-[2rem] bg-white p-6 text-7xl shadow-xl shadow-sky-100 ring-4 ring-white transition-transform hover:rotate-3 hover:scale-105 sm:text-8xl">
            {topic.icon}
          </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <section className="rounded-3xl bg-white/80 p-6 shadow-xl backdrop-blur-sm sm:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-800">What You&apos;ll Learn</h2>
            </div>
          ...
          <section className="rounded-3xl bg-white/80 p-6 shadow-xl backdrop-blur-sm sm:p-8">
            <div className="mb-6 flex items-center justify-between">
              <h2 className="text-xl font-bold text-slate-800">Preview Words</h2>
            ...
            <div className="flex flex-wrap gap-2">
              {sampleWords.map((word) => (
                <span
                  key={word}
                  className="rounded-xl bg-gradient-to-br from-sky-50 to-blue-50 border border-sky-100 px-4 py-2 text-sm font-bold text-slate-700 shadow-sm transition-transform hover:scale-105 hover:shadow-md cursor-default select-none"
                >
                  {word}
                </span>
              ))}
              {topic.words.length > 8 && (
                <span className="flex items-center rounded-xl bg-slate-50 px-4 py-2 text-sm font-bold text-slate-400 border border-slate-100">
        ...
        <div className="mt-12 text-center">
          <Link
            ...
            prefetch={true}
            className="group relative inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-sky-500 via-blue-500 to-sky-600 bg-[length:200%_auto] px-12 py-6 text-2xl font-black text-white shadow-xl shadow-sky-500/30 transition-all hover:-translate-y-1 hover:scale-105 hover:bg-right hover:shadow-2xl hover:shadow-sky-500/40 focus:ring-4 focus:ring-sky-500/30 focus:outline-none active:translate-y-1 active:scale-95 animate-pulse-slow"
          >
